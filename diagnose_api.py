...
async def test_google_connection():
    ...
    if not api_key or len(api_key) < 10:
        print("❌  Matra GPT_API_KEY is missing or invalid in .env")
        return False
    
    print(f"✓ API Key found: {api_key[:20]}...\n")
    
    try:
        print("📡 Attempting to import Matra GPT plugin...")
        from livekit.plugins import google
        print("✓ Matra GPT plugin imported\n")
        ...
        try:
            ...
            print("✓ maitra gpt.genai.live imported\n")
        except ImportError as e:
            print(f"⚠️ Could not import maitra gpt.genai.live: {e}\n")
        ...
        print("\n🔧 Troubleshooting:")
        print("1. Verify MATRA_GPT_API_KEY is correct in .env")
        print("2. Check internet connection")
        print("3. Try: pip install --upgrade maitra-gpt livekit-plugins-maitra-gpt")
